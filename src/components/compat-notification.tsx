  ...
  return (
    <div
      ...
      style={{
        ...
        borderLeft: '4px solid var(--compat-notification-border, #3b82f6)',
      ...
      {expanded && (
        <div
          style={{
            marginTop: '8px',
            paddingTop: '8px',
            borderTop: '1px solid var(--compat-divider, #bfdbfe)',
          }}
        >
          {advancedMode ? (
        ...
        <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
          ...
          <button
            ...
            style={{
              ...
              border: 'none',
              borderRadius: '6px',
              backgroundColor: 'var(--compat-btn-primary-bg, #3b82f6)',
